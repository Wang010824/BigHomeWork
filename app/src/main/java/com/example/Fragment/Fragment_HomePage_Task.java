...
import com.example.Adapter.Fragment4_Task_Adapter;
...
public class Fragment_HomePage_Task extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment4_task);
        ...
        initDatas();//初始化数据
        Fragment4_Task_Adapter adapter = new Fragment4_Task_Adapter(Fragment_HomePage_Task.this,
                R.layout.fragment4_task_listview, datas);
        mylistviews = (ListView)findViewById(R.id.listview_task);
